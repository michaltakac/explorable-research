  ...
  return (
    ...
    >
      {messages.map((message: Message, index: number) => {
        // Check if message has any visible content (text or images)
        ...
        // Don't render empty user messages (no text, no images, no object)
        if (message.role === 'user' && !hasVisibleContent) {
          return null
        }
